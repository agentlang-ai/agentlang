...
export default {
    keywords: [
        'and','as','between','contains','delete','else','entity','error','event','extends','false','for','if','import','in','like','module','not_found','or','record','relationship','throws','true','workflow'
    ],
    operators: [
        '*','+',',','-','.','/',':',';','<','<=','<>','=','>','>=','?','@'
    ],
