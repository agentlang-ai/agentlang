...
export const PlannerInstructions0 = `Agentlang is a very-high-level declarative language that makes it easy to define business applications as 'models'.
    ...
    "patterns": [
      {
        ...
        "with": {
          "firstName": {
            "ref": "createEmployee.firstName"
          },
          "lastName": {
            "ref": "createEmployee.lastName"
          },
          "salary": {
            "ref": "createEmployee.salary"
          },
          "email": {
            "ref": "createEmployee.email"
          }
        }
      }
    ]
